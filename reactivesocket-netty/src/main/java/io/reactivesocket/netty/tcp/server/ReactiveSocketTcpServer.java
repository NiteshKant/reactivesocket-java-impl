...
public class ReactiveSocketTcpServer {

    private final TcpServer<Frame, Frame> server;

    private ReactiveSocketTcpServer(TcpServer<Frame, Frame> server) {
        this.server = server;
    }
    ...
    public static ReactiveSocketTcpServer create(int port) {
        return create(TcpServer.newServer(port));
    }

    public static ReactiveSocketTcpServer create(TcpServer<ByteBuf, ByteBuf> rxNettyServer) {
        return new ReactiveSocketTcpServer(configure(rxNettyServer));
    }
